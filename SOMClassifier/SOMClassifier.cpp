...
{
	//	for(int z = 4; z<10; z+=1){

	SOM map (20, 20, 20, 644, 1000, .8);
	...
	*/
	...
	ofstream file;
	string s = map.int_to_str(10);
	string final = "Outputs\\data"+s+".txt";
	...
	outputImageFromNetwork(0, 0, 0, &map, "Outputs\\OutputOfNetworkWeights.bmp");

	final = "java -jar ConvexHull.jar "+s;
	system(final.c_str());
